...
export class MenuScene extends Phaser.Scene{
  ...
  create(){
    ...
    makeButton(this,GAME.width/2,405,340,76,'COMENZAR RUN',()=>{resetRun();this.scene.start('Placement');});
    makeButton(this,GAME.width/2,500,340,64,'ENCICLOPEDIA',()=>this.scene.start('Encyclopedia'));
  }
}
