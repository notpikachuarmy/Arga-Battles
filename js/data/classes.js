export const CLASSES = {
  rune: {
    name: 'Trazador de Runas', texture: 'rune', portrait: 'runePortrait', blessing: 'Hojafail',
    constitution: 1, energy: 3, df: 1, str: 1, int: 3, agi: 2,
    charisma: 2, will: 2, stealth: 1, perception: 2
  },
  formless: {
    name: 'Sin Forma', texture: 'formless', portrait: 'formlessPortrait', blessing: 'Fotopie',
    constitution: 2, energy: 2, df: 3, str: 2, int: 1, agi: 3,
    charisma: 2, will: 2, stealth: 3, perception: 2
  },
  demon: {
    name: 'Sangre Demoníaca', texture: 'demon', portrait: 'demonPortrait', blessing: 'Chimech-o',
